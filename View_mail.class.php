                            ...
                            <tr>
                                <td>
                                    <form action="http://1083861.shevlyak.web.hosting-test.net/wp-content/themes/Culture_FX/mail/rating.php" method="post" style="width: 100%;">
                                        ...
                                        <input type="radio" id="dont_find_connection" name="first_group_radio">
                                        ...
                                        <input type="radio" id="generated_lead" name="first_group_radio">
                                        ...
                                        <input type="radio" id="found_connection" name="first_group_radio">
                                        ...
                                        <input type="radio" id="connectioan_and_lead" name="first_group_radio">
                                        ...
                                        <input type="radio" id="not_sure" name="first_group_radio">
                                        ...
                                        <input type="radio" id="more_frequently" name="second_group_radio">
                                        ...
                                        <input type="radio" id="less_frequently" name="second_group_radio">
                                        ...
                                        <input type="radio" id="same_pace" name="second_group_radio">
                                        ...
                                        <input type="radio" id="dont_know" name="second_group_radio">
