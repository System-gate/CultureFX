...
$answer_to_db = $DB->db_update_2('mail_answers', 'answer_1 = "' . $_POST['answer_1'] . '", answer_2 = "' . $_POST['first_group_radio'] . '", answer_3 = "' . $_POST['second_group_radio'] . '", answer_4 = "' . $_POST['text'] . '"', 'id_user = "' . $_POST['user_id'] . '" AND id_pair = "' . $_POST['pare_id'] . '"');
?>
<!DOCTYPE html>
<html lang='en'>
    <head>
